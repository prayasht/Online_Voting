            ...
            <form id="allElectionName" action="ElectionviewServlet" method="post">
                ...
                <ul id="election_id">
                    <% 
                        ...
                        List<String> eleName = rcDao.getELectionName();
                        for (String ele : eleName) {
                        	Map<String,String> time = rcDao.getTime(ele);
                             ...
                             if(wins.isEmpty()){
                             	...
                             	winners=wins.toString().substring(1, wins.toString().length() - 1)+" on lead.";
                        %>
                        <li>
                            ...
                            <button type="button" class="election_btn" value="<%= ele %>">Election Title: <b><%= ele %></b>
                            <div class="remaining-time">
                            <span id="election-status">Status :</span>
...
– Abraham Lincoln</pre>
	...
	<script>
	  const form = document.getElementById("allElectionName");
